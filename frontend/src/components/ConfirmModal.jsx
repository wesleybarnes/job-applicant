    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.8)', backdropFilter: 'blur(8px)' }}>
      <div className="rounded-2xl shadow-2xl w-full max-w-2xl overflow-hidden border border-zinc-700/50" style={{ background: '#18181B' }}>
        ...
        <div className="px-6 py-4 border-b border-zinc-700/50 flex items-center gap-3"
          ...
          <div className="w-9 h-9 bg-brand-500/15 rounded-2xl flex items-center justify-center flex-shrink-0">
        ...
        <div className="px-6 py-4 border-t border-zinc-700/50 flex items-center justify-between" style={{ background: '#111114' }}>
          <button onClick={onCancel} className="btn-danger flex items-center gap-2">
            <XCircle className="w-4 h-4" /> Don't Submit
          </button>
          <button onClick={onConfirm} className="btn-gold flex items-center gap-2 text-sm py-2.5 px-5">
