...
export default function CreditsModal({ onClose }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ background: 'rgba(0,0,0,0.4)', backdropFilter: 'blur(4px)' }}>
      <div className="bg-white rounded-2xl shadow-float w-full max-w-md overflow-hidden border border-surface-border animate-slide-up">
        {/* Header */}
        ...
        <div className="p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-8">
              <Sparkles className="w-8 h-8 mx-auto mb-2 text-ink-tertiary opacity-30" />
                ...
                return (
                  <div
                    ...
                    className={`rounded-2xl border p-5 transition-all ${
                      isPopular
                        ? 'border-brand-300 bg-brand-50 ring-2 ring-brand-500/15'
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        <div className="flex items-center gap-2 mb-0.5">
                          ...
                          {isPopular && <span className="badge bg-ink-primary text-white text-xs">Popular</span>}
                        </div>
