            ...
            {step === 3 && (
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <textarea className="input min-h-[120px] resize-y" value={form.summary} onChange={e => set('summary', e.target.value)} placeholder="Summarize your experience, strengths, and what you're looking for..." />
                </div>
              </div>
            )}
              ...
              <div className="space-y-5">
                ...
                {[
                  ...
                  <div key={key}>
                    ...
                    <textarea className="input min-h-[80px] resize-y" value={form.custom_answers[key]}
